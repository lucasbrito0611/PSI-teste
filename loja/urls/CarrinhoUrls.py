...
urlpatterns = [
    ...
    path('aumentar-quantidade/<int:item_id>/', aumentar_quantidade, name='aumentar-quantidade'),
    path('diminuir-quantidade/<int:item_id>/', diminuir_quantidade, name='diminuir-quantidade'),
]