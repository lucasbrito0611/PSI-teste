...
from loja.views.ProdutoView import create_produto_view, delete_produto_postback, delete_produto_view, details_produto_view, edit_produto_postback, edit_produto_view, list_produto_view
